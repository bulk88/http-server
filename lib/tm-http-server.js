...
var fs = require('fs'),
  ...
  auth = (function(){var f; return function(){if(!f){f=require('basic-auth')}return f.apply(null,arguments)}})(),
  httpProxy = (function(){var m; return {createProxyServer: function(){if(!m){m=require('http-proxy')}return m.createProxyServer.apply(m,arguments)}}})(),
  corser = require('corser'),
  secureCompare = (function(){var f; return function(){if(!f){f=require('secure-compare')}return f.apply(null,arguments)}})();
...
function HttpServer(options) {
  ...
  this.headers['cross-origin-embedder-policy'] = 'credentialless';
